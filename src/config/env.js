...
export const env = Object.freeze({
  ...
  OPENROUTER_MODEL: readEnv('OPENROUTER_MODEL', 'deepseek/deepseek-chat-v3-0324:free'),
  OPENROUTER_FREE_FALLBACK_MODEL: readEnv('OPENROUTER_FREE_FALLBACK_MODEL', 'deepseek/deepseek-r1:free'),
